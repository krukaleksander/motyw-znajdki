...
<div id="menuAlek">
    <ul>
        <li><a href="http://znajdki.pl/">Główna</a></li>
        <li><a href="http://znajdki.pl/przygarnij/psy">Przygarnij psa</a></li>
        <li><a href="http://znajdki.pl/przygarnij/koty">Przygarnij kota</a></li>
        <li><a href="http://znajdki.pl/przygarnij/wirtualne">Opieka wirtualna</a></li>
        <li><a href="http://znajdki.pl/przygarnij/zasady-adopcjii">Zasady adopcji</a></li>
        <li><a href="http://znajdki.pl/nowedomy">W nowym domu</a></li>
        <li><a href="http://znajdki.pl/kontakt">Kontakt</a></li>
        <li><a href="http://znajdki.pl/jak-pomoc">Jak pomóc</a></li>
        <li><a href="http://znajdki.pl/wiecej/znajdki-foundation">Znajdki Foundation</a></li>
        <li><a href="http://znajdki.pl/wiecej/darczyncy-indywidualni">Darczyńcy indywidualni</a></li>
        <li><a href="http://znajdki.pl/wiecej/darczyncy-firmy">Darczyńcy firmy</a></li>
        <li><a href="http://znajdki.pl/wiecej/statut">Statut</a></li>
        <li><a href="http://znajdki.pl/wiecej/grzecznosciowe">Ogłoszenia grzecznościowe</a></li>
        <li><a href="http://znajdki.pl/wiecej/za-tm">Tęczowy most</a></li>
        <li><a href="http://znajdki.pl/wiecej/przyjaciele">Przyjaciele</a></li>
        <li><a href="http://znajdki.pl/wiecej/wolo">Wolontariusze</a></li>
        <li><a href="http://znajdki.pl/wiecej/sprawozdania-2">Sprawozdania</a></li>
    </ul>
</div>
	<div id="header">
